...
const ITEM_DICT: Record<string, string[]> = {
  ...
  '야채·수산': ['깐마늘', '양파', '대파', '청양고추', '햇감자', '애호박', '상추', '깻잎', '백오이', '당근', '새송이버섯', '팽이버섯', '알배기 배추', '제주 무', '밤', '호박고구마', '밤고구마', '양배추', '시금치', '우엉', '아욱', '참나물', '새송이', '느타리버섯', '참마', '브루콜리', '감자', '취나물', '콩나물', '숙주나물', '봄동', '배추', '생물 오징어', '손질 오징어', '제주 은갈치', '생물 고등어', '활전복', '해감 바지락', '생굴', '꽃게', '생물 새우', '주꾸미', '동태', '생태', '자른 미역', '다시마', '국물용 멸치', '볶음용 멸치'],
...
const QTY_DICT = [
  '100g', '200g', '300g', '400g', '500g', '600g(1근)', '800g', '1kg', '1개', '2개', '3개', '5개', '10개', '1팩', '2팩', '1단', '1망', '1봉', '1박스', '1마리', '2마리', '3마리', '4마리', '1손(2마리)'
];
